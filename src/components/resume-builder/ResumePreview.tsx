...
function StandardTemplate({ resume, experience, education, skills, languages, fullName, totalExpMonths }: any) {
  return (
    <div className="bg-white text-gray-900 w-[992px] rounded-md shadow-xl overflow-hidden print:shadow-none print:w-[210mm] print:min-h-[297mm] mx-auto box-border font-sans leading-normal" id="resume-preview">
...
function ModernTemplate({ resume, experience, education, skills, languages, fullName, totalExpMonths }: any) {
  return (
    <div className="bg-white text-gray-900 w-[992px] rounded-md shadow-xl overflow-hidden print:shadow-none print:w-[210mm] print:min-h-[297mm] mx-auto box-border font-sans leading-normal flex flex-col md:flex-row min-h-screen print:min-h-[297mm]" id="resume-preview">
...
function ElegantTemplate({ resume, experience, education, skills, languages, fullName }: any) {
  return (
    <div className="bg-white text-black w-[992px] rounded-md shadow-xl overflow-hidden print:shadow-none print:w-[210mm] print:min-h-[297mm] mx-auto box-border" style={{ fontFamily: "'Georgia', 'Times New Roman', serif", lineHeight: 1.7 }} id="resume-preview">
...
type TemplateFamily = "standard" | "modern" | "elegant";
...
export default function ResumePreview({
  ...
  // Prefer the server-resolved render family (handles admin template ids);
  // fall back to the raw stored value for backward compatibility.
  const rawTemplate = (resume as any).template || "standard";
  const template =
    family ??
    (rawTemplate === "modern" || rawTemplate === "elegant"
      ? rawTemplate
      : "standard");
