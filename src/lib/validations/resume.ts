...
export const resumeSchema = z.object({
  ...
  // Accepts a built-in family ("standard" | "modern" | "elegant") or an
  // admin-created template id (cuid). The render family is resolved separately.
  template: z.string().min(1).default("standard"),
});
